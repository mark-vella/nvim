return {
        ...
        -- Main LSP Configuration
        {
                ...
                config = function()
                        ...
                        -- Only enable if the copilot-language-server is installed
                        if vim.fn.executable("copilot-language-server") == 1 then
                                -- Define the copilot LSP config inline
                                                                ...
                                                                client:request(
                                                                        ...
                                                                        function(err, result)
                                                                                ...
                                                                                then
                                                                                        ...
                                                                                        vim.notify(
                                                                                                "Code copied to clipboard. Visit: "
